...
export const badgeVariants = cva(
  "rst:inline-flex rst:max-w-full rst:items-center rst:justify-center rst:font-medium rst:transition-colors rst:focus:outline-hidden rst:focus:ring-2 rst:focus:ring-ring rst:focus:ring-offset-2 rst:border",
  {
    variants: {
      variant: {
        primary: "",
